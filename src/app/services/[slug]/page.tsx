        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl md:text-7xl font-heading text-white uppercase tracking-tighter mb-4 animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
              ...
              {service.price && (
                <p className="text-2xl md:text-3xl text-brand-blue font-bold mb-2 animate-in fade-in slide-in-from-bottom-7 duration-700 delay-150">
                  {service.price}
                </p>
              )}
              <p className="text-xl md:text-2xl text-white/70 font-medium mb-2 max-w-2xl animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
                {service.tagline}
              </p>
              <p className="text-sm text-brand-blue font-bold mb-8 animate-in fade-in slide-in-from-bottom-9 duration-700 delay-250">
